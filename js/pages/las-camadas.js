...
(() => {
  ...
  const DATA = {
    "2002": {
      ...
      eye: "Camada · 2002",
      photos: [IM("assets/plantel-m15.png", "Plantel 2002", "Plantel completo"), IM("assets/salida-plantel.png", "La gira a Mendoza", "La gira a Mendoza"), IM("assets/banderazo.png", "El festejo", "El festejo")],
    ...
    "2005": {
      ...
      eye: "Camada · 2005",
      photos: [IM("assets/tribuna.png", "El equipo en la nieve", "El equipo en la nieve"), IM("assets/plantel-m15.png", "Plantel oficial 2005", "Plantel oficial"), IM("assets/tercer-tiempo.png", "Tercer tiempo", "Tercer tiempo")],
    ...
    "2008": {
      ...
      eye: "Camada · 2008",
      photos: [IM("assets/salida-plantel.png", "La final bajo la tormenta", "La final bajo la tormenta"), IM("assets/plantel-m15.png", "Plantel y cuerpo técnico", "Plantel + cuerpo técnico"), IM("assets/casa-club.png", "Vestuario después del partido", "Vestuario después del partido")],
    ...
    "2012": {
      ...
      eye: "Camada · 2012",
      photos: [IM("assets/plantel-m15.png", "Los Figallo en infantiles", "Los Figallo en infantiles"), IM("assets/tribuna.png", "Plantel campeón regional", "Plantel campeón regional"), IM("assets/salida-plantel.png", "Entrada a Cancha 1", "Entrada a Cancha 1")],
    ...
    "2015": {
      ...
      eye: "Camada · 2015",
      photos: [IM("assets/banderazo.png", "Subcampeones", "Subcampeones"), IM("assets/casa-club.png", "Concentración en BsAs", "Concentración en BsAs"), IM("assets/tercer-tiempo.png", "El asado del regreso", "El asado del regreso")],
    ...
    "2018": {
      ...
      eye: "Camada · 2018",
      photos: [IM("assets/salida-plantel.png", "El haka improvisado", "El haka improvisado"), IM("assets/plantel-m15.png", "Plantel Inferiores", "Plantel Inferiores"), IM("assets/tercer-tiempo.png", "Tercer tiempo en Córdoba", "Tercer tiempo en Córdoba")],
    ...
    "2022": {
      ...
      eye: "Camada · 2022",
      photos: [IM("assets/banderazo.png", "Banderazo en Cancha 1", "El banderazo en Cancha 1"), IM("assets/plantel-m15.png", "Plantel completo 2022", "Plantel completo"), IM("assets/tercer-tiempo.png", "La fiesta de fin de año", "La fiesta de fin de año")],
    ...
    "2026": {
      ...
      eye: "Camada · Hoy",
      photos: [IM("assets/plantel-m15.png", "Plantel M15 frente a la casa club", "M15 campeón frente a la casa roja"), IM("assets/salida-plantel.png", "La salida a la cancha", "La salida entre humo"), IM("assets/tribuna.png", "El plantel con el trofeo", "El plantel con el trofeo")],
